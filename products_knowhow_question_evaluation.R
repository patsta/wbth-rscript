...
mean_knowhow_engineer_aws <- round(mean(engineer_aws_knowhow_coded),2)
...
mean_knowhow_engineer_azure <- round(mean(engineer_azure_knowhow_coded),2)
...
mean_knowhow_engineer_cf <- round(mean(engineer_cf_knowhow_coded),2)
...
mean_knowhow_engineer_kubernetes <- round(mean(engineer_kubernetes_knowhow_coded),2)
...
mean_knowhow_engineer_linux <- round(mean(engineer_linux_knowhow_coded),2)
...
mean_knowhow_engineer_vmware <- round(mean(engineer_vmware_knowhow_coded),2)
...
mean_knowhow_engineer_windows <- round(mean(engineer_windows_knowhow_coded),2)
...
mean_knowhow_agile_aws <- round(mean(agile_aws_knowhow_coded),2)
...
mean_knowhow_agile_azure <- round(mean(agile_azure_knowhow_coded),2)
...
mean_knowhow_agile_cf <- round(mean(agile_cf_knowhow_coded),2)
...
mean_knowhow_agile_kubernetes <- round(mean(agile_kubernetes_knowhow_coded),2)
...
mean_knowhow_agile_linux <- round(mean(agile_linux_knowhow_coded),2)
####################################################################################
# Future Skills - Technical product - Agile Know-How VMware
####################################################################################
filtered_vmware_agile_knowhow <- `VMware (e.g. NSX, vCenter)`[`Which area best fits your job?` == 'Agile roles']
...
mean_knowhow_agile_vmware <- round(mean(agile_vmware_knowhow_coded),2)
...
mean_knowhow_agile_windows <- round(mean(agile_windows_knowhow_coded),2)



# Barplot
product_names <- c("AWS", "Azure", "Cloudfoundry", "Kubernetes", "Linux", "VMware", "Windows")
engineer_data <- c(mean_knowhow_engineer_aws, mean_knowhow_engineer_azure, mean_knowhow_engineer_cf, mean_knowhow_engineer_kubernetes, mean_knowhow_engineer_linux,mean_knowhow_engineer_vmware, mean_knowhow_engineer_windows)
agile_data <- c(mean_knowhow_agile_aws, mean_knowhow_agile_azure, mean_knowhow_agile_cf, mean_knowhow_agile_kubernetes, mean_knowhow_agile_linux,mean_knowhow_agile_vmware, mean_knowhow_agile_windows)

data_sorted_by_product <- c(
                            mean_knowhow_engineer_aws, 
                            mean_knowhow_agile_aws, 
                            mean_knowhow_engineer_azure, 
                            mean_knowhow_agile_azure, 
                            mean_knowhow_engineer_cf, 
                            mean_knowhow_agile_cf, 
                            mean_knowhow_engineer_kubernetes, 
                            mean_knowhow_agile_kubernetes, 
                            mean_knowhow_engineer_linux, 
                            mean_knowhow_agile_linux, 
                            mean_knowhow_engineer_vmware,
                            mean_knowhow_agile_vmware, 
                            mean_knowhow_engineer_windows, 
                            mean_knowhow_agile_windows
                     )
